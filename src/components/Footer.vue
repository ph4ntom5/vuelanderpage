<template>
  ...
  <section>
    <div class="row contact-section">
      <div class="icon ps-5 pt-5">
        <img src="../assets/icon-location.svg" alt="white location pin icon" />
      </div>
      <div class="contacts">
  ...
  <section>
    <div class="row contact-section">
      <div class="icon ps-5 pt-5">
        <img src="../assets/icon-phone.svg" alt="white location pin icon" />
      </div>
  ...
  <section class="mt-5">
    ...
    <ul class="first-group mt-5">
      <li><a href="#">Contact Us</a></li>
      <li><a href="#">Terms</a></li>
      <li><a href="#">Privacy</a></li>
    </ul>
  </section>
  <section class="socials pt-5 pb-5 mx-auto text-center">
    <svg
